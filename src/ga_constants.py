...
def get_compression_timeout(compressor_type: str, params: Dict = None, file_size_mb: float = None) -> int:
    ...
    Timeouts are disabled - returns very large timeout for all scenarios.
    ...
    Returns:
        Timeout in seconds (very large value to effectively disable timeouts)
    """
    # Return very large timeout to effectively disable timeout restrictions
    # 24 hours timeout for all compression operations
    return 86400
